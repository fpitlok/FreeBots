...
class Talk(object):
    ...
    @loggedIn
    def getRecentMessagesV2(self, msgid, count=1000):
        return self.talk.getRecentMessagesV2(msgid, count)
    ...
    @loggedIn
    def ReceiveMessage(self, msg, db, database):
        if msg.toType == 0:
            ...
            msg.to = msg.to
        if db['unsendMessage'] == True:
            if msg.to not in database['message']:
                database['message'][msg.to] = {}
                return
            if msg.id not in database['message'][msg.to]:
                database['message'][msg.to][msg.id] = {"msg": msg, "type": msg.contentType, "from": msg._from, "msgid": msg.id}
            if msg.contentType == 1:
                if 'MEDIA_CONTENT_INFO' in msg.contentMetadata.keys() != None:
                    if 'DOWNLOAD_URL' not in msg.contentMetadata:
                        path = self.downloadObjectMsg(msg.id,'path','%s.gif' % msg.id,True)
                        database["message"][msg.to][msg.id]["path"] = path
                    else:
                        database["message"][msg.to][msg.id]["path"] = msg
                elif 'MEDIA_CONTENT_INFO' not in msg.contentMetadata:
                    if 'PREVIEW_URL' in msg.contentMetadata.keys() != None:
                        database["message"][msg.to][msg.id]["path"] = msg
                    else:
                        path = self.downloadObjectMsg(msg.id)
                        database["message"][msg.to][msg.id]["path"] = path
            if msg.contentType == 2:
                if "DOWNLOAD_URL" in msg.contentMetadata.keys() != None:
                    database["message"][msg.to][msg.id]["path"] = msg
                else:
                    path = self.downloadObjectMsg(msg.id)
                    database["message"][msg.to][msg.id]["path"] = path
            ...
            if msg.contentType == 14:
                path = self.downloadObjectMsg(msg.id)
                database['message'][msg.to][msg.id]['msg'] = msg
                database['message'][msg.to][msg.id]['path'] = path

    @loggedIn
    def DetectUnsend(self, op, db, database):
        msg_id = op.param2
        if db['unsendMessage'] == True:
            msg = database["message"][op.param1][op.param2]["msg"]
            if op.param2 in database["message"][op.param1]:
                if msg.toType == 0:
                    if msg._from != self.profile.mid:
                        msg.to = msg._from
                    else:
                ...
                if msg.contentType == 0:
                    if msg.text != None:
                        a = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/PGJt3qP/Pics-Art-12-07-05-41-20.png","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : Text","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : {}".format(str(msg.text)),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/xxx"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~zarifoglu_"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/birkutumavi"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
                        b = self.sendCarousel(msg.to, a)
                if msg.contentType == 1:
                    if "MEDIA_CONTENT_INFO" in msg.contentMetadata.keys() != None:
                        a = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/PGJt3qP/Pics-Art-12-07-05-41-20.png","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : Image/GIF","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : Check the GIF Below","size":"xs","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/xxx"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~zarifoglu_"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/birkutumavi"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
                        self.sendCarousel(msg.to, a)
                        if 'DOWNLOAD_URL' not in msg.contentMetadata:
                            self.sendGIF(msg.to, database['message'][msg.to][msg.id]['path']);os.remove('{}.gif'.format(msg.id))
                        else:
                            try:
                                data = {"messages": [{"type":"image","originalContentUrl": msg.contentMetadata['DOWNLOAD_URL'] ,"previewImageUrl": msg.contentMetadata['PREVIEW_URL'],"animated":True,"extension":"gif","sentBy":{"label": msg.contentMetadata['AGENT_NAME'],"iconUrl": msg.contentMetadata['AGENT_ICON'],"linkUrl": msg.contentMetadata['AGENT_LINK']}}]}
                            except:
                                data = {"messages": [{"type":"image","originalContentUrl": msg.contentMetadata['DOWNLOAD_URL'] ,"previewImageUrl": msg.contentMetadata['PREVIEW_URL'],"animated":True,"extension":"gif"}]}
                            self.sendCarousel(msg.to, data)
                    elif 'MEDIA_CONTENT_INFO' not in msg.contentMetadata:
                        a = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/PGJt3qP/Pics-Art-12-07-05-41-20.png","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : Image/JPEG","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : Check the Image Below","size":"xs","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/xxx"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~zarifoglu_"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/birkutumavi"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
                        self.sendCarousel(msg.to, a)
                        if 'PREVIEW_URL' in msg.contentMetadata.keys() != None:
                            try:
                                data = {"messages": [{"type":"image","originalContentUrl": msg.contentMetadata['DOWNLOAD_URL'],"previewImageUrl": msg.contentMetadata['PREVIEW_URL'],"sentBy":{"label": msg.contentMetadata['AGENT_NAME'],"iconUrl": msg.contentMetadata['AGENT_ICON'],"linkUrl": msg.contentMetadata['AGENT_LINK']}}]}
                            except:
                                data = {"messages": [{"type":"image","originalContentUrl": msg.contentMetadata['DOWNLOAD_URL'],"previewImageUrl": msg.contentMetadata['PREVIEW_URL']}]}
                            self.sendCarousel(msg.to, data)
                        else:
                            self.sendImage(msg.to, database["message"][msg.to][msg.id]["path"])
                if msg.contentType == 2:
                    a = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/PGJt3qP/Pics-Art-12-07-05-41-20.png","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : Video","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : Check the Video Below","size":"xs","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/xxx"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~zarifoglu_"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/birkutumavi"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
                    self.sendCarousel(msg.to, a)
                    if 'PREVIEW_URL' in msg.contentMetadata.keys() != None:
                        self.sendCarousel(msg.to,{"messages": [{"type": "video","altText": "YouTube","originalContentUrl": msg.contentMetadata['DOWNLOAD_URL'],"previewImageUrl": msg.contentMetadata["PREVIEW_URL"]}]})
                    else:
                        self.sendVideo(msg.to, database['message'][msg.to][msg.id]['path'])
                if msg.contentType == 3:
                    a = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/PGJt3qP/Pics-Art-12-07-05-41-20.png","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : Audio","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : Check the Audio Below","size":"xs","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/xxx"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~zarifoglu_"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/birkutumavi"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
                    self.sendCarousel(msg.to, a)
                    if 'PREVIEW_URL' in msg.contentMetadata.keys() != None:
                        self.sendCarousel(msg.to,{"messages": [{"type": "audio","altText": "YouTube","originalContentUrl": msg.contentMetadata['DOWNLOAD_URL'],"duration": 60000}]})
                    else:
                        self.sendAudio(msg.to, database['message'][msg.to][msg.id]['path'])
                if msg.contentType == 14:
                    a = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/PGJt3qP/Pics-Art-12-07-05-41-20.png","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : File","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : Check the File Below","size":"xs","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/xxx"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~zarifoglu_"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/birkutumavi"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
                    self.sendCarousel(msg.to, a)
                    self.sendFile(msg.to, database['message'][msg.to][msg.id]['path'], file_name=msg.contentMetadata['FILE_NAME'])
                if msg.contentType == 7:
                    try:
                        data = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/PGJt3qP/Pics-Art-12-07-05-41-20.png","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : Sticker","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : Check the Sticker Below","size":"xs","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/xxx"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~zarifoglu_"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/birkutumavi"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
                        self.sendCarousel(msg.to, data)
                        ...
                        else:data = {"messages": [{"type": "image","originalContentUrl": 'https://stickershop.line-scdn.net/stickershop/v1/sticker/'+str(msg.contentMetadata['STKID'])+'/ANDROID/sticker.png;compress=true',"previewImageUrl": 'https://stickershop.line-scdn.net/stickershop/v1/sticker/'+str(msg.contentMetadata['STKID'])+'/ANDROID/sticker.png;compress=true'}]}
                        ab = self.sendCarousel(msg.to, data)
